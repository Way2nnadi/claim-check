  ...
  "candidate_rules": [
    {
      ...
      "applicability": {
        "aggregation_period": "per_transaction" | "per_day" | "per_trip" | "per_night" | "per_attendee",
...
Rules:
- Emit one candidate rule per distinct policy requirement. Prefer atomic rules over compound sentences.
