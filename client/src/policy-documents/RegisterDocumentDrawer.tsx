...
export default function RegisterDocumentDrawer({
  ...
  const documentAlreadyExists = existingDocumentIds.includes(normalizedDocumentId);
          ...
          >
            ...
            {documentAlreadyExists && documentIdIsValid ? (
              <p className="catalog-register-note">
                This id is already indexed — upload will append a new version to the existing
                record.
              </p>
            ) : null}

            <label className="version-upload-dropzone compact" htmlFor="register-document-file">
              <input
                key={uploadInputKey}
