...
export default function AuditLogPage() {
  ...
  return (
    <div className="catalog-page audit-page">
      ...
      <section className="audit-overview" aria-label="Audit overview">
        <article className="audit-stat-card">
          <span className="audit-stat-label">Events in scope</span>
          <strong className="audit-stat-value">
            {status === "loading" ? "…" : events.length}
          </strong>
        </article>
        <article className="audit-stat-card">
          <span className="audit-stat-label">Actors represented</span>
          <strong className="audit-stat-value">
            {status === "loading" ? "…" : uniqueActorCount}
          </strong>
        </article>
        <article className="audit-stat-card">
          <span className="audit-stat-label">Entity classes</span>
          <strong className="audit-stat-value">
