import { downloadDocumentVersion } from "../../policy-documents/api";
import { downloadPolicyVersionSnapshot } from "../../policy-versions/api";
...
describe("apiRequest", () => {
  ...
  it("posts Policy Version publish requests with JSON bodies", async () => {
    ...
    const { publishPolicyVersion } = await import("../../policy-versions/api");
  ...
  it("builds extraction run query parameters", async () => {
    ...
    const { fetchExtractionRuns } = await import("../../extraction-runs/api");
  ...
  it("builds candidate rule query parameters", async () => {
    ...
    const { fetchCandidateRules } = await import("../../candidate-rules/api");
  ...
  it("builds audit event query parameters", async () => {
    ...
    const { fetchAuditEvents } = await import("../../audit/api");
  ...
  it("patches candidate rule review updates with JSON bodies", async () => {
    ...
    const { updateCandidateRule } = await import("../../candidate-rules/api");
  ...
  it("posts candidate rule approvals with JSON bodies", async () => {
    ...
    const { approveCandidateRule } = await import("../../candidate-rules/api");
  ...
  it("posts bulk candidate rule approvals with JSON bodies", async () => {
    ...
    const { approveCandidateRulesBulk } = await import("../../candidate-rules/api");
  ...
  it("posts candidate rule rejections with JSON bodies", async () => {
    ...
    const { rejectCandidateRule } = await import("../../candidate-rules/api");
  ...
  it("posts extraction run create requests with JSON bodies", async () => {
    ...
    const { createExtractionRun } = await import("../../extraction-runs/api");
  ...
  it("posts re-ingestion requests as multipart form data", async () => {
    ...
    const { reingestDocument } = await import("../../reingestion/api");
