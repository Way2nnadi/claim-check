...
You are the **publisher** — push this branch and open a PR for the work already implemented and reviewed on `{{BRANCH}}`.
...
1. Confirm the branch has commits and tests pass: `uv run pytest` and `uv run ruff check .`
